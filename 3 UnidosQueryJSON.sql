SELECT * FROM ZZPRUEBA_ENC, ZZPRUEBADET, ZZRECAUDOS

--Opcion 1
select 
A.TipoInterfaz AS [Encabezado.TipoInterfaz], 
A.SAP_DEN_SOC_FINAN AS [Encabezado.SAP_DEN_SOC_FINAN],
A.ClaseDocumento AS [Encabezado.ClaseDocumento],
A.ReferenciaDocumento AS [Encabezado.ReferenciaDocumento],
A.OrgVentaSAP AS [Encabezado.OrgVentaSAP],
A.MonedaDocumento AS [Encabezado.MonedaDocumento],
A.Sector AS [Encabezado.Sector],
A.OficinaVentaSAP AS [Encabezado.OficinaVentaSAP],
A.GrupoVendedorSAP AS [Encabezado.GrupoVendedorSAP],
A.CodigoClienteSAP AS [Encabezado.CodigoClienteSAP],
A.NombreCliente AS [Encabezado.NombreCliente],
A.Direccion1 AS [Encabezado.Direccion1],
A.Poblacion AS [Encabezado.Poblacion],
A.RegionSAP AS [Encabezado.RegionSAP],
A.Telefono1 AS [Encabezado.Telefono1],
A.Destinatario AS [Encabezado.Destinatario],
A.NumeroSAP AS [Encabezado.NumeroSAP],
A.Fecha AS [Encabezado.Fecha],
A.FechaEntrega AS [Encabezado.FechaEntrega],
A.FechaPrecio AS [Encabezado.FechaPrecio],
A.Moneda AS [Encabezado.Moneda],
A.TipoCambio AS [Encabezado.TipoCambio],
A.CondicionPago AS [Encabezado.CondicionPago],
A.CondicionExpedicion AS [Encabezado.CondicionExpedicion],
A.Texto AS [Encabezado.Texto],
A.MotivoPedido AS [Encabezado.MotivoPedido],
B.ClaseDoc AS [Posiciones.ClaseDoc],
B.NumeroSAP AS [Posiciones.NumeroSAP],
B.Linea AS [Posiciones.Linea],
B.Material AS [Posiciones.Material],
B.Cantidad AS [Posiciones.Cantidad],
B.UnidadMedida AS [Posiciones.UnidadMedida],
B.TipoPosicion AS [Posiciones.TipoPosicion],
B.CentroCosto AS [Posiciones.CentroCosto],
B.CodigoAlmacen AS [Posiciones.CodigoAlmacen],
B.CondicionPrecio AS [Posiciones.CondicionPrecio],
B.PrecioBase AS [Posiciones.PrecioBase],
B.PrecioBaseTotal AS [Posiciones.PrecioBaseTotal],
B.DsctoAuto AS [Posiciones.DsctoAuto],
B.Dscto AS [Posiciones.Dscto],
B.ValorDcsto AS [Posiciones.ValorDcsto],
B.CondicionSoles AS [Posiciones.CondicionSoles],
B.Soles AS [Posiciones.Soles],
B.ValorSoles AS [Posiciones.ValorSoles],
B.CondicionDsctoManual AS [Posiciones.CondicionDsctoManual],
B.DsctoManual AS [Posiciones.DsctoManual],
B.ValordsctoManual AS [Posiciones.ValordsctoManual],
B.CondicionBonificacion AS [Posiciones.CondicionBonificacion],
B.PorcentajeBonificacion AS [Posiciones.PorcentajeBonificacion],
B.ValorBonificacion AS [Posiciones.ValorBonificacion],
B.CondicionFlete AS [Posiciones.CondicionFlete],
B.PorcentajeFlete AS [Posiciones.PorcentajeFlete],
B.ValorFlete AS [Posiciones.ValorFlete],
B.CondicionRecargoM AS [Posiciones.CondicionRecargoM],
B.PorcentajeRecargoM AS [Posiciones.PorcentajeRecargoM],
B.ValorRecargoM AS [Posiciones.ValorRecargoM],
B.CondicionIVA AS [Posiciones.CondicionIVA],
B.PorcentajeIVA AS [Posiciones.PorcentajeIVA],
B.ValorIVA AS [Posiciones.ValorIVA],
B.CondicionProvisionSoles AS [Posiciones.CondicionProvisionSoles],
B.ImporteProvisionSoles AS [Posiciones.ImporteProvisionSoles],
B.ValorProvisionSoles AS [Posiciones.valorProvisionSoles],
C.Campo03 AS [Recaudo.Campo03],
C.Campo04 AS [Recaudo.Campo04],
C.Campo05 AS [Recaudo.Campo05],
C.Campo06 AS [Recaudo.Campo06],
C.Campo07 AS [Recaudo.Campo07],
C.Campo08 AS [Recaudo.Campo08],
C.Campo09 AS [Recaudo.Campo09],
C.Campo10 AS [Recaudo.Campo10],
C.Campo11 AS [Recaudo.Campo11],
C.Campo12 AS [Recaudo.Campo12],
C.Campo13 AS [Recaudo.Campo13],
C.Campo14 AS [Recaudo.Campo14],
C.Campo15 AS [Recaudo.Campo15],
C.Campo16 AS [Recaudo.Campo16],
C.Campo17 AS [Recaudo.Campo17],
C.Campo18 AS [Recaudo.Campo18],
C.Campo19 AS [Recaudo.Campo19],
C.Campo20 AS [Recaudo.Campo20],
C.Campo21 AS [Recaudo.Campo21],
C.Campo22 AS [Recaudo.Campo22],
C.Campo23 AS [Recaudo.Campo23],
C.Campo24 AS [Recaudo.Campo24],
C.Campo25 AS [Recaudo.Campo25],
C.Campo26 AS [Recaudo.Campo26]
from ZZPRUEBA_ENC A, ZZPRUEBADET B, ZZRECAUDOS C
for json path, ROOT('CompraVentaICG')

--Opcion2
DECLARE @CANJEO INT 
SET @CANJEO = (SELECT VALOR   FROM PARAMETROS WHERE CLAVE = 'FIDEL' AND SUBCLAVE = 'EDTOS') SELECT 
(
select top 1
...
where C.NUMSERIE='AAAF' AND C.NUMFAC='178177'     FOR JSON PATH) DataVentasEnc,     
(
select
...
CASE 
WHEN F.DPTO IN ('6')  AND B.REFERENCIA NOT IN ('200301') THEN 'TAX' 
WHEN F.DPTO IN ('6')  AND B.REFERENCIA IN ('200301') THEN 'ZFFR'
...
where A.NUMSERIE='AAAF' AND A.NUMFAC='178177' 
for json path) DataVentasDet,     (
select
'C' as Campo03,
'Z001' as Campo04,
'1000'as Campo05,
...
FOR JSON PATH) DataRecaudo FOR JSON PATH
...
inner Join ALBVENTALIN H
on A.NUMSERIE = H.NUMSERIE AND A.NUMALBARAN = H.NUMALBARAN
where A.NUMSERIE='AAAF' AND A.NUMFAC='178174';
Insert into ZZRECAUDOSXML
Select top 1 
'P' as Campo03,
...
inner Join ALBVENTALIN H
on A.NUMSERIE = H.NUMSERIE AND A.NUMALBARAN = H.NUMALBARAN
where A.NUMSERIE='AAAF' AND A.NUMFAC='178174' GROUP BY A.NUMSERIEFAC,E.CODTIPOPAGO,D.CTA_EFECTIVO,F.CUENTACOBRO,E.IMPORTE,G.RAIZCOBROS,D.SAP_OFICINAS_VENTAS,G.RAIZPAGOS,D.SAP_GRUPO_VENDEDOR;
Insert into ZZRECAUDOSXML
Select top 1
'P' as Campo03,
...
inner Join ALBVENTALIN H
on A.NUMSERIE = H.NUMSERIE AND A.NUMALBARAN = H.NUMALBARAN
where A.NUMSERIE='AAAF' AND A.NUMFAC='178174' GROUP BY A.NUMSERIEFAC, C.CODCLIENTESAP, E.IMPORTE, G.RAIZCOBROS, D.SAP_OFICINAS_VENTAS, G.RAIZPAGOS, D.SAP_GRUPO_VENDEDOR; 
SELECT 
(
    select TOP 1
    'Z001' as TipoInterfaz,
...
    Inner Join ALBVENTALIN F
    on C.NUMSERIE = F.NUMSERIE
where C.NUMSERIE='AAAF' AND C.NUMFAC='178174' FOR JSON PATH ) DataVentasEnc, 
(
    select
    CASE WHEN RIGHT(A.NUMSERIEFAC,1) IN  ('F','H','G','J','K') THEN 'ZPOS' WHEN RIGHT(A.NUMSERIEFAC,1) IN ('L','M','N','O','Y') THEN 'YPOS' ELSE '' END as ClaseDoc, 
    LTRIM(A.NUMSERIE) + REPLICATE('0',12-LEN(A.NUMFAC))+LTRIM(A.NUMFAC) AS NumeroSAP,
...
    INNER JOIN ARTICULOS F ON B.CODARTICULO = F.CODARTICULO
    INNER JOIN ALMACEN G ON B.CODALMACEN = G.CODALMACEN
where A.NUMSERIE='AAAF' AND A.NUMFAC='178174' FOR JSON PATH ) DataVentasDet, 
(
    SELECT TOP 3 * FROM ZZRECAUDOSXML FOR JSON PATH ) DataRecaudo  
FOR JSON PATH